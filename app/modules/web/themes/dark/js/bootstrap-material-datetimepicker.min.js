...
"h":"H";this.$dtpElement.find(".dtp-picker-datetime").removeClass("hidden");this.$dtpElement.find(".dtp-picker-calendar").addClass("hidden");for(var b=this.createSVGClock(!0),d=0;12>d;d++){var c=-(162*Math.sin(d/12*-Math.PI*2)),e=-(162*Math.cos(d/12*-Math.PI*2)),f=this.currentDate.format(a)==d?"#8BC34A":"transparent",g=this.currentDate.format(a)==d?"#000":"#000",f=this.createSVGElement("circle",{id:"h-"+d,"class":"dtp-select-hour",style:"cursor:pointer",r:"30",cx:c,cy:e,fill:f,"data-hour":d}),c=this.createSVGElement("text",
...
0;12>d;d++)c=-(110*Math.sin(d/12*-Math.PI*2)),e=-(110*Math.cos(d/12*-Math.PI*2)),f=this.currentDate.format(a)==d+12?"#8BC34A":"transparent",g=this.currentDate.format(a)==d+12?"#000":"#000",f=this.createSVGElement("circle",{id:"h-"+(d+12),"class":"dtp-select-hour",style:"cursor:pointer",r:"30",cx:c,cy:e,fill:f,"data-hour":d+12}),c=this.createSVGElement("text",{id:"th-"+(d+12),"class":"dtp-select-hour-text","text-anchor":"middle",style:"cursor:pointer","font-weight":"bold","font-size":"22",x:c,y:e+
...
d=a.find(".dtp-select-hour-text");for(c=0;c<d.length;c++)e(d[c]).attr("fill","#000");e(a.find("#h-"+b)).attr("fill","#8BC34A");e(a.find("#th-"+b)).attr("fill","#000");this.currentDate.hour(parseInt(b));!0===this.params.shortTime&&this.isPM()&&this.currentDate.add(12,"hours");this.showTime(this.currentDate);this.animateHands();!0===this.params.switchOnClick&&setTimeout(this.initMinutes.bind(this),200)}},_onSelectMinute:function(a){if(!e(a.target).hasClass("disabled")){var b=e(a.target).data("minute");
a=e(a.target).parent();for(var d=a.find(".dtp-select-minute"),c=0;c<d.length;c++)e(d[c]).attr("fill","transparent");d=a.find(".dtp-select-minute-text");for(c=0;c<d.length;c++)e(d[c]).attr("fill","#000");e(a.find("#m-"+b)).attr("fill","#8BC34A");e(a.find("#tm-"+b)).attr("fill","#000");this.currentDate.minute(parseInt(b));this.showTime(this.currentDate);this.animateHands();!0===this.params.switchOnClick&&setTimeout(function(){this.setElementValue();this.hide()}.bind(this),200)}},_onSelectAM:function(a){e(".dtp-actual-meridien").find("a").removeClass("selected");
